...
const DigitalBrochure = () => {
    usePageSEO({
        ...
        description: 'View the POLYMAT2026 digital brochure online – conference overview, core objectives, key themes including Polymer Fundamentals, Vortex Dynamics, CFD, and AI in Flow Analysis.',
        canonical: 'https://polymat2026.com/digital-brochure',
    });
    return (
                    ...
                    <div className="brochure-content">
                        <header className="brochure-header">
                            ...
                            <h1 className="brochure-main-title">
                                CONFERENCE ON POLYMAT THEORY <br />
                                <span>AND Composite Materials</span>
                            </h1>
                        </header>
                ...
                <div className="brochure-sheet">
                    <div className="sheet-inner">
                        ...
                        <p className="sheet-description">
                            The INTERNATIONAL CONFERENCE ON POLYMERS AND COMPOSITE MATERIALS is the premier gathering for experts in vortex identification and turbulence science. This summit bridges the gap between pure mathematics and practical engineering.
                        </p>
                        ...
                        <div className="sheet-grid">
                            <div className="sheet-section">
                                ...
                                <ul className="sheet-list">
                                    <li><CheckCircle size={14} /> Advance the knowledge of Polymer Matrix applications.</li>
                        ...
                        <div className="sheet-section full-width">
                            ...
                            <div className="themes-flex">
                                <span className="theme-tag">Polymer Fundamentals</span>
